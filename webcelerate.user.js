...
(() => {
  ...
  function initChatGPT() {
    const MAPPINGS = {
      ...
      "F4": { label: "GPT5 Thinking Mini", match: "gpt5 thinking mini", legacy: true },
    };
    ...
    log("ChatGPT: Ready - F1=5.1 Instant, F2=5.1 Thinking, F3=o3, F4=GPT5 Thinking Mini (auto-select enabled)");
  }
